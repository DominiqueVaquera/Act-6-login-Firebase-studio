...
class SignUp extends StatelessWidget {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  _customInput(label: "Username"),
                  _customInput(label: "Email"),
                  _customInput(label: "Password", obscureText: true),
                  _customInput(label: "Confirm Password", obscureText: true),
                ],
              ),
              Container(
                ...
                child: MaterialButton(
                  ...
                  child: const Text("Sign up", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 18, color: Colors.white)),
                ),
              ),
              Row(
  ...
  Widget _customInput({label, obscureText = false}) {
    return Column(
